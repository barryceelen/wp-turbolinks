...
(function() {
  ...
  fetchReplacement = function(url, options) {
    ...
    xhr.onload = function() {
      ...
      if (doc = processResponse()) {
        ...
        loadedNodes = changePage.apply(null, __slice.call(extractTitleAndBody(doc)).concat([options]));
  ...
  replace = function(html, options) {
    ...
    loadedNodes = changePage.apply(null, __slice.call(extractTitleAndBody(createDocument(html))).concat([options]));
  ...
  changePage = function(title, body, csrfToken, options) {
    var appendedNodes, changedNodes, currentBody, nodesToAppend, nodesToChange, nodesToKeep, nodesToPrepend, nodesToReplace, prependedNodes, replacedNodes, _ref;
    title = (_ref = options.title) != null ? _ref : title;
  ...
  swapNodes = function(targetBody, existingNodes, options) {
    var changedNodes, childNode, childNodes, existingNode, firstChild, nodeId, targetNode, _i, _j, _len, _len1;
    changedNodes = [];
  ...
  nestedWithinNodeList = function(nodeList, element) {
    while (element != null) {
      if (__indexOf.call(nodeList, element) >= 0) {
        return true;
      }
      element = element.parentNode;
    }
  ...
  executeScriptTags = function(scripts) {
    var attr, copy, nextSibling, parentNode, script, _i, _j, _len, _len1, _ref, _ref1;
  ...
  reflectNewUrl = function(url) {
    var _ref;
    if ((_ref = (url = new ComponentUrl(url)).absolute) !== referer && _ref !== document.location.href) {
  ...
  ProgressBar = (function() {
    ...
    ProgressBar.prototype.start = function(_arg) {
      var delay,
        _this = this;
      delay = (_arg != null ? _arg : {}).delay;
  ...
  onHistoryChange = function(event) {
    var cachedPage, newUrl, previousUrl, _ref;
